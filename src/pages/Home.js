...
const FEATURE_LIST = [
  ...
  },
  {
    ...
    subTitle:
      'Flashcard phương pháp học từ vựng nổi tiếng. Nay hoàn toàn miễn phí trên EngloLearn',
    imgUrl: flashcardIcon,
    to: ROUTES.FLASHCARD,
  },
  {
    title: 'Từ điển trong EngloLearn',
...
function HomePage() {
  useTitle('EngloLearn - Ứng dụng học tiếng Anh miễn phí');
  useScrollTop();
